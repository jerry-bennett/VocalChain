...
class VocalChainAudioProcessorEditor  : public AudioProcessorEditor, public Slider::Listener, public Button::Listener, public Timer
{
public:
    VocalChainAudioProcessorEditor (VocalChainAudioProcessor&);
    ~VocalChainAudioProcessorEditor();
...
private:
    ...
    //type then name of thing
    //same as int variable;
    Slider gainSlider;
